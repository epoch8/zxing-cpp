...
emcmake cmake -B . -S .. -DCMAKE_TOOLCHAIN_FILE="$CMAKE_TOOLCHAIN_FILE" -DOpenCV_DIR="$OPENCV_PATH" -DBUILD_FOR_WASM=ON -DCMAKE_BUILD_TYPE=Release -DENABLE_WASM_SIMD=ON
if [ ! -f "Makefile" ]; then
